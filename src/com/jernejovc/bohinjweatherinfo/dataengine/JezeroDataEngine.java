...
public class JezeroDataEngine implements DataEngineInterface {	
	...
	public String[] getLabels() {
		...
		if(locale.equalsIgnoreCase("slovenščina"))
			return new String [] {"Čas podatkov", "Zunanja temperatura", "Povprečna temperatura", "Temperatura jezera", "Vlažnost", "Zračni tlak", "Rosišče", "Veter"};
		else
			return new String [] {"Data time", "Outside temperature", "Average temperature", "Lake temperature", "Humidity", "Pressure", "Dew", "Wind"};
	}
}